...
|------------|------|---------|
| https://library-charts.snixon.github.io/helm-charts | common | 4.5.2 |

## TL;DR

```console
helm repo add snixon https://snixon.github.io/helm-charts/charts/
helm repo update
helm install tdarr snixon/tdarr
```
...
```console
helm install tdarr snixon/tdarr -f values.yaml
```
...
- See the [Docs](https://docs.snixon.github.io/helm-charts/our-helm-charts/getting-started/)
